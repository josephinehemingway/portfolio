...
export const designExperience: Experience[] = [
    {
        ...
        desc: 'As the creative director, I design floral arrangements and all sorts of marketing materials ranging from Instagram posts, website design, gift cards and more. I also do my own product and event photography.',
...
export const projects: Project[] = [
    ...
    },
    {
        ...
        techStack: ['React', 'TypeScript', 'Python', 'Flask', 'MongoDB', 'BeautifulSoup', 'Plotly', 'Google Maps API'],
        url: 'https://youtu.be/B_oDP7XlETI?si=0y0T7aAkooTgptQv'
    },
    {
        title: 'ElonSearch',
        imgUrls: [El1, El2],
        desc: 'An AI powered surveillance application. Food delivery aggregation application to save delivery fees. Food delivery aggregation application to save delivery fees',
    ...
    },
    {
        ...
        techStack: ['React', 'TypeScript', 'Python', 'Flask', 'MongoDB', 'AWS S3 Bucket', 'OpenCV', 'Deepface', 'Telegram Bot API'],
        url: 'https://youtu.be/TaXVs3rlhDo?si=LMjURxWYa1z5orEs'
    },
    {
        title: 'Food Buddy',
        imgUrls: [gsfb1, gsfb2, gsfb3,],
        desc: 'Food delivery aggregation application to save delivery fees. Food delivery aggregation application to save delivery fees. Food delivery aggregation application to save delivery fees',
...
export const mobileProjects: Project[] = [
    {
        ...
        techStack: ['React', 'JavaScript', 'Computer Vision', 'Mediapipe Pose', 'OpenCV'],
    },
    {
        title: "Healthy Go Where",
        imgUrls: [hfgw1, hfgw2, hfgw3, hfgw4, hfgw5, hfgw6, hfgw7, hfgw8],
        desc: 'The project that started it all. A mobile application to suggest healthy eateries or healthy recipes',
...
export const otherProjects: Project[] = [
    {
        ...
        imgUrls: [notecard],
        desc: 'Using Telegram Bot to generate notecards to streamline operations for The Blooming Palette.',
        techStack: ['OpenCV', 'AWS Lambda', 'Telegram Bot API'],
    },
    {
        title: "Telegram Admin Assistant",
        imgUrls: [admin],
        desc: 'Telegram Bot to update sales and expenses database on the go.',
